var root = {
    "name": "Taxonomia", "nivel": 0, "bloco": "raiz", "children": [
        {
            "name": "Conceitual", "nivel": 1, "bloco": "conceitual", "children": [
        ...
        {
            "name": "Tecnologias", "nivel": 1, "bloco": "tecnologia", "children": [
                { "name": "Plataforma", "nivel": 2, "bloco": "tecnologia" },
                { "name": "Hardware", "nivel": 2, "bloco": "tecnologia" },
                {
                    "name": "Desenvolvimento", "nivel": 2, "bloco": "tecnologia", "children": [
        ...
        {
            "name": "Funcionalidades", "nivel": 1, "bloco": "funcionalidade", "children": [
                {
                    "name": "Visualização da Informação", "nivel": 2, "bloco": "funcionalidade", "children": [
                        { "name": "Técnica", "nivel": 3, "bloco": "funcionalidade" },
                        { "name": "Informação", "nivel": 3, "bloco": "funcionalidade" }
                    ]
                },
                {
                    "name": "Coleta de Dados", "nivel": 2, "bloco": "funcionalidade", "children": [
                        { "name": "Tipo de Dado", "nivel": 3, "bloco": "funcionalidade" },
                        { "name": "Estratégia", "nivel": 3, "bloco": "funcionalidade" },
                        { "name": "Processamento de Dados", "nivel": 3, "bloco": "funcionalidade" }
                    ]
                },
                { "name": "Tipo de Informação", "nivel": 2, "bloco": "funcionalidade" },
                {
                    "name": "Interação entre usuários", "nivel": 2, "bloco": "funcionalidade", "children": [
        ...
        {
            "name": "Aspectos Gerais", "nivel": 1, "bloco": "apecto", "children": [
...
function montaArvore() {
    ...
    var tree = d3.layout.tree().size([360, diameter / 2 - 90])
        .separation(function (a, b) { return (a.parent == b.parent ? 1 : 2) / a.depth; });

    var diagonal = d3.svg.diagonal.radial()
        .projection(function (d) { return [d.y, d.x / 180 * Math.PI]; });

    var svg = d3.select("#taxonomy_tree").append("svg")
    ...
    var node = svg.selectAll(".node")
        .data(nodes)
        .enter().append("g")
        .attr("class", function (d) { return d.bloco + " node" })
        .attr("transform", function (d) { if (d.nivel == 0) { return "rotate(60.25)translate(30)" } else { return "rotate(" + (d.x - 90) + ")translate(" + d.y + ")"; } })

    node.append("circle")
        .attr("r", function (d) { if (d.nivel == 0) { return 50 } else { return 25 - d.nivel * 5 } });
    ...
    node.append("text")
        ...
        .attr("transform", function (d) { if (d.nivel == 0) { return "rotate(-60)translate(-40)" } else { return d.x < 180 ? "translate(30)" : "rotate(180)translate(-35)"; } })
